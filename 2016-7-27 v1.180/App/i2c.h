...
#define I2CDEV		LPC_I2C1
    ...
    * Returned value:      	无
    *********************************************************************************************************/
    extern uint8_t C1025_WriteByte(uint32 ads,uint8_t dat);
    ...
    *********************************************************************************************************/
    extern uint8_t C1025_ReadByte(uint32 ads);
    ...
    * Returned value:      	无
    *********************************************************************************************************/
    extern uint16_t WriteData16(uint32 ads,uint16_t dat);
    ...
    * Returned value:      	读取的数据
    *********************************************************************************************************/
    extern uint16_t ReadData16(uint32 ads);
    ...
    * Returned value:      	无
    *********************************************************************************************************/
    extern uint32_t WriteData32(uint32 ads,uint32_t dat);
    ...
    * Returned value:      	读取的数据
    *********************************************************************************************************/
    extern uint32_t ReadData32(uint32 ads);
    ...
    * Returned value:      	无
    *********************************************************************************************************/
    extern float WriteFp32(uint32 ads,float dat);
    ...
    * Returned value:      	读取的数据
    *********************************************************************************************************/
    extern float ReadFp32(uint32 ads);
