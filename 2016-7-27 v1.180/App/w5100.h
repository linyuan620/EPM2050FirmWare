...
extern unsigned short LastResDataLen;
extern uint8 Close_Flg;

extern unsigned char S0_Data;					/* Socket0 receive data and transmit OK */

extern unsigned char W5100_Interrupt;
extern void SPIInit_w5100(void);

extern void MSPIInit(void);
extern void MSPISendData(uint8 uiData);
extern INT8U MSPIRcvByte (void);
extern unsigned char Read_W5100(unsigned short addr);
extern void Write_W5100(unsigned short addr, unsigned char dat);
extern void W5100_Init(void);
extern unsigned char Socket_Init(SOCKET s);
...
extern void vPrintString(unsigned char *ucpString);
